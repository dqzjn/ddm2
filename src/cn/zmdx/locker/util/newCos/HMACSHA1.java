...
public class HMACSHA1 {
	...
	public static String getFileSha1(String path) throws IOException {
		...
		String sha1=getFileSha1(in);
		in.close();
		return sha1;
	}
	
	public static String getFileSha1(FileInputStream fileStream) throws IOException {
	...
	public static String getFileSha1(byte[] byteArray) {
		MessageDigest messagedigest;
		try {
			messagedigest = MessageDigest.getInstance("SHA-1");
...
//			}
	...
	public static String getFormattedText(final byte[] bytes) {
